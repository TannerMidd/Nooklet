...
export const serviceConnectionTypeSchema = z.enum(["ai-provider", "tautulli", "plex", "sabnzbd", "tmdb", "tvdb", "trakt"]);
...
export const apiKeyServiceConnectionSchema = z.object({
  serviceType: z.enum(["tautulli", "plex", "sabnzbd", "tmdb", "tvdb", "trakt"]),
  baseUrl: z.string().trim().url("Enter a valid base URL."),
  apiKey: apiKeySchema,
});
