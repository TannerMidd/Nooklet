...
export const serviceConnectionTypeSchema = z.enum(["ai-provider", "sonarr", "radarr", "tautulli", "plex", "sabnzbd", "tmdb", "trakt"]);
...
export const apiKeyServiceConnectionSchema = z.object({
  serviceType: z.enum(["sonarr", "radarr", "tautulli", "plex", "sabnzbd", "tmdb", "trakt"]),
  baseUrl: z.string().trim().url("Enter a valid base URL."),
  apiKey: apiKeySchema,
});
