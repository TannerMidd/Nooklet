 ...
 */
export async function hasActiveDownloadAssociationForTitle(userId: string, titleId: string) {
 ...
 */
export async function hasActiveDownloadAssociationForLibraryPath(userId: string, pathId: string) {
    const database = ensureDatabaseReady();
                ...
                and(
                    ...
                    or(
                        and(
                            ...
                            or(
                                inArray(downloadRequests.status, [
                                    ...activeDownloadRequestStatuses,
                                ]),
                                inArray(downloadQueueItems.status, [...activeQueueItemStatuses]),
                                inArray(engineDownloads.state, [...activeEngineDownloadStates]),
