...
export type DownloadCapacityDisposition =
    "active_reservation_contention" | "candidate_oversized" | "storage_insufficient";
...
export function classifyDownloadCapacityFailure(
    ...
    const availableAfterActiveCleanup = capacity.availableBytes + capacity.activeDownloadedBytes;
