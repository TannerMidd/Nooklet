...
export async function acquireSeasonFulfillmentWorkLease(userId: string, fulfillmentId: string) {
...
export async function renewSeasonFulfillmentWorkLease(lease: SeasonFulfillmentWorkLease) {
    return renewMediaRequestAttempt(lease, SEASON_FULFILLMENT_WORK_LEASE_TTL_MS);
}

export function releaseSeasonFulfillmentWorkLease(lease: SeasonFulfillmentWorkLease) {
