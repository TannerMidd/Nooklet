...
function parseWatchHistorySourceTypes(metadataJson: string | null | undefined) {
    ...
    try {
        ...
        console.error(
            "[preferences-repository] failed to parse watchHistorySourceTypesJson",
            error,
        );
...
export async function upsertPreferences(input: UpsertPreferencesInput) {
    ...
    database
        ...
        .values({
            ...
            watchHistorySourceTypesJson: serializeWatchHistorySourceTypes(
                input.watchHistorySourceTypes,
            ),
