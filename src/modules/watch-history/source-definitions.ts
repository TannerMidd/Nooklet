...
export const watchHistorySourceDefinitions = [
    {
        ...
        description:
            "Paste watched titles directly when you want explicit control over the imported list.",
    },
    {
        sourceType: "plex",
        displayName: "Direct Plex sync",
        description:
            "Use a verified Plex server and token to import recent watched history directly.",
    },
    {
        sourceType: "tautulli",
        displayName: "Tautulli sync",
        description:
            "Use a verified Tautulli connection to import recent Plex history through Tautulli.",
    },
    {
        sourceType: "trakt",
        displayName: "Trakt sync",
        description:
            "Use a verified Trakt connection to import watched shows and movies from your Trakt account.",
    },
