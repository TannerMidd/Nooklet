...
describe("seasonMonitoring", () => {
    it("monitors every season except specials for entire-series selections", () => {
        ...
        expect(seasonMonitoring(policy, 0)).toEqual({
            monitoredOnInsert: false,
            forceMonitored: false,
        });
        expect(seasonMonitoring(policy, 1)).toEqual({
    ...
    it("monitors and re-monitors only the selected seasons", () => {
        ...
        expect(seasonMonitoring(policy, 2)).toEqual({
            monitoredOnInsert: true,
            forceMonitored: true,
        });
        expect(seasonMonitoring(policy, 1)).toEqual({
    ...
    it("monitors only the season that owns the selected episodes", () => {
        ...
        expect(seasonMonitoring(policy, 3)).toEqual({
            monitoredOnInsert: true,
            forceMonitored: true,
        });
        expect(seasonMonitoring(policy, 1)).toEqual({
...
describe("episodeMonitoring", () => {
    it("monitors only the explicitly selected episodes", () => {
        ...
        expect(episodeMonitoring(policy, 1, 3)).toEqual({
            monitoredOnInsert: true,
            forceMonitored: true,
        });
        expect(episodeMonitoring(policy, 1, 4)).toEqual({
            monitoredOnInsert: false,
            forceMonitored: false,
        });
        expect(episodeMonitoring(policy, 2, 3)).toEqual({
            monitoredOnInsert: false,
            forceMonitored: false,
        });
    });
    ...
    it("monitors episodes of selected seasons", () => {
        ...
        expect(episodeMonitoring(policy, 1, 5)).toEqual({
            monitoredOnInsert: true,
            forceMonitored: true,
        });
        expect(episodeMonitoring(policy, 2, 5)).toEqual({
            monitoredOnInsert: false,
            forceMonitored: false,
        });
    });
    ...
    it("keeps specials unmonitored for entire-series selections", () => {
        ...
        expect(episodeMonitoring(policy, 0, 1)).toEqual({
            monitoredOnInsert: false,
            forceMonitored: false,
        });
        expect(episodeMonitoring(policy, 1, 1)).toEqual({
            monitoredOnInsert: true,
            forceMonitored: false,
        });
    });
