...
import { QuickActionPalette, QuickActionTrigger } from "@/components/layout/quick-action-palette";
            ...
            <div className="min-h-screen lg:pl-56">
                <header className="sticky top-0 z-30 flex min-h-14 items-center justify-between border-b border-cream/[0.07] bg-background/95 px-4 backdrop-blur lg:hidden">
                    ...
                    >
                        ...
                        <span className="nooklet-wordmark text-[20px] leading-none text-foreground">
                            Nooklet
                        </span>
                    </Link>
                ...
                >
                    <div className="flex items-center px-5 pb-4 pt-5">
                        ...
                        >
                            <span
                                aria-hidden="true"
                                className="nk-brand-dot h-[9px] w-[9px] shrink-0"
                            />
                ...
                <main
                    id="main-content"
                    tabIndex={-1}
                    className="min-w-0 px-4 pb-12 pt-6 sm:px-6 lg:px-12 lg:pb-16 lg:pt-9"
                >
