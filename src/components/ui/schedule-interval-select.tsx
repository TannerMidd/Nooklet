...
export function ScheduleIntervalSelect({ name, defaultValue, unit, invalid, className }: ScheduleIntervalSelectProps) {
  ...
  return (
    ...
    >
      {!hasDefault ? <option value={defaultValue}>{customLabel(defaultValue, unit)} (current)</option> : null}
