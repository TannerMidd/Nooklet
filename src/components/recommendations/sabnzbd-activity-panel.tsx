...
export function SabnzbdActivityPanel({ initialState, className }: SabnzbdActivityPanelProps) {
  ...
  if (queueState.connectionStatus === "disconnected") {
    return null;
  }
  ...
  return (
    <Panel
      ...
      description="Recommendarr reads the live SABnzbd queue so you can see active download progress without leaving the app."
      className={className}
    >
