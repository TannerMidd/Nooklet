    ...
    return (
        <section className="space-y-4">
            ...
            <p className="text-xs leading-5 text-muted">
                Provider availability is sourced from JustWatch via TMDB and may not reflect every
                region.
            </p>
        </section>
    );
...
export function RecommendationSimilarTitlesSection({ similar }: { similar: TmdbSimilarTitle[] }) {
    if (similar.length === 0) {
        return null;
    }
