...
import { initialRecommendationLibraryActionState } from "@/app/(workspace)/recommendation-action-state";
        ...
        >
            ...
            <span>
                {pending
                    ? "Requesting..."
                    : (completionLabel ??
                      (downloadNow ? "Request & download" : "Add to library only"))}
            </span>
        </Button>
    );
}
        ...
        return (
            <p
                ...
                className={cn(
                    ...
                    tone === "error" &&
                        "border border-accent-wine/30 bg-accent-wine/10 text-accent-wine",
                )}
            >
                {message}
            </p>
