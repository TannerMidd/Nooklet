    ...
    <div className="space-y-3">
      {indexer ? (
        <div className="flex flex-wrap items-center gap-2 text-xs text-muted">
          <span className="rounded-lg border border-cream/[0.08] bg-cream/[0.03] px-3 py-1 capitalize">
            {indexer.status}
          </span>
          <span className="rounded-lg border border-cream/[0.08] bg-cream/[0.03] px-3 py-1">
            {indexer.isEnabled ? "Enabled" : "Disabled"}
          </span>
          {indexer.maskedApiKey ? (
            <span className="rounded-lg border border-cream/[0.08] bg-cream/[0.03] px-3 py-1 font-mono">
              {indexer.maskedApiKey}
            </span>
          ) : null}
        </div>
