    ...
    return (
        <form action={formAction} className="space-y-5">
            <div className="grid gap-3.5 md:grid-cols-[0.28fr,0.42fr,0.3fr]">
                ...
                <label className="space-y-1.5">
                    ...
                    {state.fieldErrors?.plexUserId ? (
                        <p className="text-sm text-accent-wine">{state.fieldErrors.plexUserId}</p>
                    ) : null}
                </label>
            ...
            <p className="text-sm leading-6 text-muted">
                ...
                titles, and replaces the previously imported Plex list for the chosen media type.
            </p>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <SubmitButton />
                <p className="text-sm leading-6 text-muted">
                    The selected user is persisted with the Plex source so repeat syncs stay scoped
                    cleanly.
                </p>
            </div>
        </form>
