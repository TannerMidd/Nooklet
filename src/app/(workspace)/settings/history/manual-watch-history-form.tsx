    ...
    return (
        <form action={formAction} className="space-y-5">
            <div className="grid gap-3.5 md:grid-cols-[0.32fr,1fr]">
                ...
                <label className="space-y-1.5">
                    ...
                    <p className="text-sm leading-6 text-muted">
                        Use one title per line. Add a year in parentheses when it matters. The first
                        line is treated as the most recent watched item, and each sync replaces the
                        previous imported list for that media type.
                    </p>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <SubmitButton />
                <p className="text-sm leading-6 text-muted">
                    Manual sync stays useful when you want explicit title control or do not have a
                    provider-backed history source configured.
                </p>
            </div>
        </form>
    );
