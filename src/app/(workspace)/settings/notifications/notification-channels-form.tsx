          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <label className="space-y-1 text-sm">
              ...
              <select
                ...
                className="h-10 w-full rounded-lg border border-cream/[0.08] bg-cream/[0.04] px-3 text-sm text-foreground"
              >
          ...
          <fieldset className="space-y-2">
            ...
            <div className="grid gap-2 md:grid-cols-2">
              {notificationEventTypes.map((event) => (
                <label
                  key={event}
                  className="flex items-center gap-2 rounded-lg border border-cream/[0.08] bg-cream/[0.04] px-3 py-2 text-sm text-foreground"
                >
                  <input
                    type="checkbox"
                    name="events"
        ...
        {channels.length === 0 ? (
          ...
          <ul className="space-y-3">
            {channels.map((channel) => (
              <li
                key={channel.id}
                className="space-y-3 rounded-lg border border-cream/[0.08] bg-cream/[0.04] p-4"
              >
