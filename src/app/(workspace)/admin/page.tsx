    ...
    <div className="nk-enter space-y-7">
      ...
      >
        <ul className="grid gap-3 text-sm leading-6 text-foreground md:grid-cols-4">
            <li className="rounded-lg border border-cream/[0.08] bg-cream/[0.04] px-4 py-3">
      ...
      >
        <div className="overflow-x-auto rounded-lg border border-cream/[0.08]">
          <table className="min-w-full border-collapse text-left text-sm text-foreground">
            <thead className="bg-cream/[0.04] text-xs font-medium text-muted">
              <tr>
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-t border-cream/[0.08] bg-cream/[0.03]">
