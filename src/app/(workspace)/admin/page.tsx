    ...
    <div className="space-y-5">
      ...
      >
        <ul className="grid gap-3 text-sm leading-6 text-foreground md:grid-cols-4">
            <li className="rounded-lg border border-line/45 bg-panel-strong/45 px-4 py-3">
      ...
      >
        <div className="overflow-x-auto rounded-lg border border-line/45">
          <table className="min-w-full border-collapse text-left text-sm text-foreground">
            <thead className="bg-panel-strong/35 text-xs font-medium text-muted">
              <tr>
