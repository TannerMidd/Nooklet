...
export default async function AdminPage() {
    const [session, users] = await Promise.all([requireAdminSession(), listUsersOverview()]);
        ...
        <div className="nk-enter space-y-7">
            ...
            <div className="rounded-2xl border border-accent/20 bg-accent/[0.06] p-5 text-sm leading-6 text-foreground">
                ...
                <p className="mt-1 text-muted">
                    Administrators can change storage, built-in downloader settings, indexers, and
                    every user account. Keep at least one active administrator, and grant this role
                                ...
                                <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                    <div className="min-w-0">
                                        <div className="flex flex-wrap items-center gap-2">
                                            ...
                                            {isCurrentAdmin ? (
                                                <Badge variant="accent-cool">You</Badge>
                                            ) : null}
                                        </div>
