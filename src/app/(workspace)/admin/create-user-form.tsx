...
import { initialCreateManagedUserActionState } from "@/app/(workspace)/admin/action-state";
        ...
        <form action={formAction} className="space-y-5">
            ...
            <div className="grid gap-3.5 md:grid-cols-[0.7fr,1fr,1fr]">
                <FormField
                    ...
                    description="Users can request media; admins can change instance configuration."
                >
                    {(controlProps) => (
                        <select
                            {...controlProps}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <p className="text-sm leading-6 text-muted">
                    New accounts can use shared services and storage immediately. History and
                    notifications remain personal.
                </p>
            </div>
        </form>
    );
