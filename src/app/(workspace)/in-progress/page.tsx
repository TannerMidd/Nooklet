...
export default async function ActivityPage({ searchParams }: ActivityPageProps) {
    ...
    const currentView: DownloadActivityView =
        requestedView === "active" || requestedView === "attention" || requestedView === "completed"
            ? requestedView
            : "active";
    ...
    return (
        <div className="nk-enter space-y-8">
            ...
            <form action="/in-progress" className="flex max-w-xl flex-col gap-2 sm:flex-row">
                ...
                <button
                    type="submit"
                    className="min-h-11 rounded-lg border border-cream/[0.14] px-5 text-sm font-semibold text-foreground hover:bg-cream/[0.06]"
                >
                    Search history
                </button>
            </form>
                ...
                {activity.pagination.pageCount > 1 ? (
                    ...
                    >
                        ...
                        <span className="text-muted">
                            Page {activity.pagination.page} of {activity.pagination.pageCount} ·{" "}
                            {activity.pagination.total} items
                        </span>
